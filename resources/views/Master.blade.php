      ...
      <nav class="bg-primary fixed z-50 top-0 right-0 w-screen border-gray-200 px-2 sm:px-4 py-2.5">
            <div class="container flex flex-wrap justify-between items-center mx-auto">
              ...
              <div class="hidden absolute bg-primary right-0 top-14 md:top-0 w-full md:block md:relative z-30 md:w-auto" id="navbar-default">
                <ul class="flex flex-col p-4 mt-4  border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0">
                  <li>
                    <a href="/" class="block py-2 pr-4 pl-3 text-white rounded hover:text-primary hover:bg-white md:bg-transparent md:p-0 md:hover:underline md:hover:underline-offset-2 md:hover:text-secondary md:hover:bg-transparent {{ ( $title === "Home") ? 'font-bold' : '' }}" aria-current="page">Home</a>
                  </li>
                  <li>
                    <a href="#" class="block py-2 pr-4 pl-3 text-white rounded hover:text-primary hover:bg-white md:border-0 md:hover:underline md:hover:underline-offset-2 md:hover:text-secondary md:hover:bg-transparent md:p-0">Tour</a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="#" class="block py-2 pr-4 pl-3 text-white rounded hover:text-primary hover:bg-white md:border-0 md:hover:underline md:hover:underline-offset-2 md:hover:text-secondary md:hover:bg-transparent md:p-0"><i class="fa-solid fa-arrow-right-to-bracket mr-1"></i> Login</a>
                  </li>
                </ul>
              </div>
            </div>
