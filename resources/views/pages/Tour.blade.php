       ...
       <div class="card_wrap flex justify-center xl:justify-start self-center container gap-4 flex-wrap">
          ...
          <div class="tour_card hidden max-w-xs rounded-lg  shadow-md bg-secondary onDay">
              ...
              <div class="p-5">
                  ...
                  <a href="{{ url('/detail') }}" class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-primary rounded-md hover:bg-hover focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-primary ">
                      Read more
