...
<section class="container h-auto m-auto mt-5">
    <div class="section_title text-center text-lg font-bold text-text xl:text-2xl">Tour Package
        <hr class="thin_line border-s w-4/5 m-auto md:w-1/2 border-primary xl:mt-1 xl:w-4/5">
        <hr class="bold_line m-auto w-36 border-2 rounded-b-md border-primary xl:w-1/4">
    </div>
    ...
    {{-- button view more --}}
    <a href="#" class="button text-base font-semibold text-text  mt-4 self-center md:text-lg">view more <i class="fa-solid fa-circle-arrow-right text-primary text-xs md:text-sm hover:text-hover"></i></a>
    </div>
</section>
    ...
    <div class="about_wrap w-11/12 container m-auto flex relative">
        <div class="about_m_content md:w-1/2 xl:w-2/3">
            <h1 class="about_title text-text xl:text-2xl"><span class="font-bold">WHY </span>BOOK WITH US
                <hr class="thin_line border-s w-4/5 md:w-1/2 border-primary xl:mt-1 xl:w-4/5">
                <hr class="bold_line w-1/4 border-2 rounded-br-md border-primary">
            </h1>
