        ...
        @endif  
            ...
            <div class="block p-6 rounded-lg shadow-lg bg-white w-96">
                  <form action="/regist" method="POST" class="LoginForm">
                    ...
                    <input type="submit" value="Signup" class="w-full px-6 py-2.5 bg-primary text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-hover hover:shadow-lg focus:bg-primary focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">
                  </form>
                </div>
      </section>
</body>
